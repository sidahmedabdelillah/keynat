...
// debut
$q2Red = "SELECT * from article WHERE quantite < seuil2 order by cle";
addToLog($q2Red);
$r2Red = mysqli_query($dbc, $q2Red);
$num2Red = mysqli_num_rows($r2Red);
...
<div class="col-md-12">
    ...
    <li class="active"><a data-toggle="tab" href="#seuil1">Seuil 1 (<?= $num1 ?>)</a></li>
       <!--  163  a 284-->
        ...
        <!-- 286 a 410 -->
        <li><a data-toggle="tab" href="#seuil2Reduit">Seuil 2 reduit (<?= $num2 ?>)</a></li>
        <!-- 411-->
        ...
        <div id="seuil1" class="tab-pane fade in active">
            <table class="table table-hover table-striped" id="articleTable1">
                ...
                <tr>
                    ...
                    <td class=" nottoprint">
                      <?= date("d-m-y", strtotime($date_four1)) ?>
                    </td> 
                    <td class="">
                        <?= $four2['four_id'] ?>
                    </td>
      ...
      <table class="table table-hover table-striped" id="articleTable2">
          ...
          while ($articles = mysqli_fetch_assoc($r2)){
            $designiation = str_replace("eliminer","<em>eliminer</em>",$articles['designiation']);
              ...
              $first = calculerFour1_2($articles['cle']);
              if ($first == 1){
                  $four1 = "1";
                  $prix_four1= "";
                  $cle_four1= "";
                  ...
                  $four1 = $first['id_four'];
                  $prix_four1= $first['prix_achat'];
                  $cle_four1= $first['cle_article_four'];
                  $date_four1= $first['date_achat'];
              }

              $second = calculerFour2_2($articles['cle']);
              if ($second == 1){
                  $four2 = "2";
                  $prix_four2= "";
                  $cle_four2= "";
                  ...
                  $four2 = $second['id_four'];
                  $prix_four2= $second['prix_achat'];
                  $cle_four2= $second['cle_article_four'];
                  $date_four2= $second['date_achat'];
              }

              $theard = calculerFour3_2($articles['cle']);
              if ($theard == 1){
                  $four3 = "3";
                  $prix_four3= "";
                  $cle_four3= "";
                  ...
                  $four3 = $theard['id_four'];
                  $prix_four3= $theard['prix_achat'];
                  $cle_four3= $theard['cle_article_four'];
                  $date_four3= $theard['date_achat'];
              }
          ?>
          <tr>
              <td class=""><?= $articles['cle'] ?></td>
              <td style="word-wrap: break-word;" class="col-xs-2"><?= substr($designiation,0,50) ?></td>
              <td class=""><?= $articles['quantite'] ?></td>
              <td class=""><?= $articles['prix_achat'] ?></td>
              <td class="">
                  <?= $four1 ?>
              ...
              <td class=" nottoprint">
                <?= date("d-m-y", strtotime($date_four2)) ?>
              </td> 
              ...
              <td class=" nottoprint"> 
                 <?= date("d-m-y", strtotime($date_four3)) ?>
              </td> 
  ...
  ?>
    ...
    <!-- debut id="seuil2 reduit " -->
    <div id="seuil2Reduit" class="tab-pane fade in">

<table class="table table-hover table-striped" id="articleTable2">
    <tr>
        <th class="">CleReduit</th>
        <th class="col-xs-2">Des</th>
        <th class="">Qte</th>
        <th class="">P A</th>
        <th class="" onclick="sortTable(articleTable2,4)">F 1</th>
    ...
    <?php
    while ($articlesRed = mysqli_fetch_assoc($r2Red)){
      $designiationRed = str_replace("eliminer","<em>eliminer</em>",$articlesRed['designiation']);

        $first = calculerFour1_2($articlesRed['cle']);
        if ($first == 1){
            $four1 = "1";
            $prix_four1= "";
            $cle_four1= "";
        ...
        $second = calculerFour2_2($articlesRed['cle']);
        if ($second == 1){
            $four2 = "2";
            $prix_four2= "";
            $cle_four2= "";
        ...
        $theard = calculerFour3_2($articlesRed['cle']);
        if ($theard == 1){
            $four3 = "3";
            $prix_four3= "";
            $cle_four3= "";
    ...
    ?>
    <tr>
        <td class=""><?= $articlesRed['cle'] ?></td>
        <td style="word-wrap: break-word;" class="col-xs-2"><?= substr($designiationRed,0,60) ?></td>
        <td class=""><?= $articlesRed['quantite'] ?></td>
        <td class=""><?= $articlesRed['prix_achat'] ?></td>
        <td class="">
            <?= $four1 ?>
        </td>
        <!-- <td class="">
        ...
        <td style="color:red;" class="col-xs-1"><b><?= $articlesRed['seuil2'] ?></b></td>
    </tr>
